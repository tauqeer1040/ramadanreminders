...
- **AI-powered diary** — write a reflection, get a personalized Islamic insight.
- **Tasbih** — track dhikr with custom lists and statistics.
- **Quran** — read with the Amiri font and keep bookmarks.
- **Prayer times** — accurate times based on your location.
